...
struct s3c_reg_data {
	...
	enum s3cfb_reg_state_t	state[S3C_FB_MAX_WIN];
};
...
#define S3CFB_WIN_BUFFER		_IOW('F', 210, unsigned long)
#define S3CFB_WIN_BUFFER_N		_IOW('F', 211, unsigned long)
